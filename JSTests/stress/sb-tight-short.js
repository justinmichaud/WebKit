//@ runDefault
// StringBuilder correctness: tight loop of very-short accumulation, no GC (the inline-short-rope residual case).
...
noInline(ref);
function check(msg, x, y) { if (x !== y) throw new Error("tight-short: " + msg + " got " + JSON.stringify(x) + " want " + JSON.stringify(y)); }
