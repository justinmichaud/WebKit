//@ runDefault
// StringBuilder correctness: >3-piece op_strcat accumulator (V += a + b + c + d + ...), the tagcloud shape.
...
function ref(n) {
    var a = [];
    for (var i = 0; i < n; i++) { a.push("<a n=", i, " k=", i*3, " c=", i&15, ">", "t" + (i&7), "</a> "); }
    return a.join("");
}
noInline(ref);
function check(msg, x, y) { if (x !== y) throw new Error("strcat-chain: " + msg + " got " + JSON.stringify(x) + " want " + JSON.stringify(y)); }
